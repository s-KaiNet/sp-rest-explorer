...
```bash
INIT=$(node ./.opencode/get-shit-done/bin/gsd-tools.js init map-codebase)
```
...
```bash
node ./.opencode/get-shit-done/bin/gsd-tools.js commit "docs: map existing codebase" --files .planning/codebase/*.md
```
